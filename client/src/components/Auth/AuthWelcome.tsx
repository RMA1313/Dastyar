    ...
    <div className="space-y-8 text-center animate-auth-card">
      <div className="flex flex-col items-center gap-4">
        ...
        <h2 className="text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl">
          به دستیار تخصصی آینده‌پژوهی خوش آمدید
        </h2>

        <p className="max-w-2xl text-base leading-relaxed text-slate-600 dark:text-slate-300">
          آینده، چشم‌انداز هوشمند ایران.  
          لطفاً برای ادامه ورود یا ثبت‌نام را انتخاب کنید.
        </p>
      </div>
      ...
      <div className="mx-auto flex w-full max-w-lg flex-col gap-3 sm:flex-row">
        ...
        <Button
          type="button"
          variant="secondary"
          className="h-12 w-full rounded-2xl border border-slate-200 bg-white/85 text-slate-800 transition duration-200 hover:-translate-y-[1px] dark:bg-slate-900/70 dark:text-white dark:border-white/10"
