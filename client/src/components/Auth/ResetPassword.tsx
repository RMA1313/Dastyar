...
function ResetPassword() {
      ...
      <>
        ...
        >
          <div className="flex flex-col space-y-4">
            <p>اکنون می‌توانید با گذرواژه جدید وارد شوید.</p>
            <Button
  ...
  return (
    <form
      ...
      aria-label="فرم بازنشانی گذرواژه"
      method="POST"
          ...
          <input
            ...
            {...register('password', {
              ...
              minLength: {
                ...
                message: 'طول گذرواژه کافی نیست.',
              },
              maxLength: {
                value: 128,
                message: 'طول گذرواژه بیش از حد است.',
              },
            })}
      ...
      <div className="mb-2">
        <div className="relative">
          <input
            type="password"
            id="confirm_password"
            aria-label="تکرار گذرواژه"
            {...register('confirm_password', {
              validate: (value) => value === password || 'تکرار گذرواژه یکسان نیست.',
            })}
